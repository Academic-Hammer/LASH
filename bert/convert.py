...
if __name__ == "__main__":
    ...
    with open(f'data/{args["dataset"]}/{args["mode"]}/bert_embedding/{args["mode"]}_embd128_{args["local_rank"]}.pkl', 'wb') as f:
        joblib.dump(bundle, f)
        
    with open(f'data/{args["dataset"]}/{args["mode"]}/bert_embedding/{args["mode"]}_idx128_{args["local_rank"]}.pkl', 'wb') as f:
        joblib.dump(index, f)
